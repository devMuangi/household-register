        ...
        >
            ...
            >
                <Heading
                    ...
                    letterSpacing="tight"
                >
                    Welcome back, <Flex display="inline-flex" fontWeight="bold">CHEW</Flex>
                </Heading>
                
                <Flex justifyContent="space-between" mt={8}>
                    <Flex align="flex-end">
                        <Heading as="h2" size="lg" letterSpacing="tight">Your community health units</Heading>
                        ...
                        <Table variant="unstyled" mt={4}>
                            <Thead>
                                <Tr color="gray">
                                    <Th>Name of CHU</Th>
                                    <Th>villages</Th>
                                    <Th isNumeric>households</Th>
                                    <Th isNumeric>CHVs</Th>
                                ...
                                <Tr>
                                    <Td>
                                        <Flex align="center">
                                            ...
                                            <Flex flexDir="column">
                                                <Heading size="sm" letterSpacing="tight">Ukunda Scheme</Heading>
                                                <Text fontSize="sm" color="gray">Last updated Apr 24, 2021 at 1:40pm</Text>
                                            </Flex>
                                        </Flex>
                                    </Td>
                                    <Td>Kinondo</Td>
                                    <Td isNumeric>200</Td>
                                    <Td isNumeric><Text fontWeight="bold" display="inline-table">2</Text></Td>
                                </Tr>
                                <Tr>
                                    <Td>
                                        <Flex align="center">
                                            ...
                                            <Flex flexDir="column">
                                                <Heading size="sm" letterSpacing="tight">Mvindeni scheme</Heading>
                                                <Text fontSize="sm" color="gray">Last updated Apr 22, 2021 at 2:43pm</Text>
                                            </Flex>
                                        </Flex>
                                    </Td>
                                    <Td>Kinondo</Td>
                                ...
                                <Tr>
                                    <Td>
                                        <Flex align="center">
                                            ...
                                            <Flex flexDir="column">
                                                <Heading size="sm" letterSpacing="tight">Kona Msa</Heading>
                                                <Text fontSize="sm" color="gray">ALast updated pr 13, 2021 at 11:23am</Text>
                                            </Flex>
                                        </Flex>
                                    </Td>
                                    <Td>Kinondo</Td>
                                        ...
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    {/* <Avatar size="sm" mr={2} src="amazon.jpeg" /> */}
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">Msambweni</Heading>
                                                        <Text fontSize="sm" color="gray">Last updated Apr 12, 2021 at 9:40pm</Text>
                                                    </Flex>
                                                </Flex>
                                            </Td>
                                            <Td>Kinondo</Td>
                                        ...
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    {/* <Avatar size="sm" mr={2} src="starbucks.png" /> */}
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">Kinondo</Heading>
                                                        <Text fontSize="sm" color="gray">Last updated Apr 10, 2021 at 2:10pm</Text>
                                                    </Flex>
                                                </Flex>
                                            </Td>
                                            <Td>Kinondo</Td>
                                        ...
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    ...
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">Ukunda Scheme</Heading>
                                                        <Text fontSize="sm" color="gray"Last updated >Apr 7, 2021 at 9:03am</Text>
                                                    </Flex>
                                                </Flex>
                                            </Td>
                                            <Td>Kinondo</Td>
                ...
                <Text color="gray" fontSize="sm">Statistics</Text>
                <Text fontWeight="bold" fontSize="2xl">3000</Text>
                <MyChart />
            </Flex>
            ...
            >
                ...
                <Heading letterSpacing="tight">My stats</Heading>
               {/*  
                {value == 1 &&
                    <Box
                        borderRadius="25px"
